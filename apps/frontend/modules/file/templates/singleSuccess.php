<script type="text/javascript">
      kDefaultURL = '<?php echo '/uploads/usersharedfile/'.$utoconsult_file->getFile(); ?>';
</script>

<div id="controls">
      <button id="previous" onclick="PDFView.page--;" oncontextmenu="return false;">
        <img src="/js/mozilla-pdf.js-d823592/web/images/go-up.svg" align="top" height="16"/>
        Previous
      </button>

      <button id="next" onclick="PDFView.page++;" oncontextmenu="return false;">
        <img src="/js/mozilla-pdf.js-d823592/web/images/go-down.svg" align="top" height="16"/>
        Next
      </button>
      ...
      <button id="zoomOut" title="Zoom Out" onclick="PDFView.zoomOut();" oncontextmenu="return false;">
        <img src="/js/mozilla-pdf.js-d823592/web/images/zoom-out.svg" align="top" height="16"/>
      </button>
      <button id="zoomIn" title="Zoom In" onclick="PDFView.zoomIn();" oncontextmenu="return false;">
        <img src="/js/mozilla-pdf.js-d823592/web/images/zoom-in.svg" align="top" height="16"/>
      </button>
      ...
      <button id="print" onclick="window.print();" oncontextmenu="return false;">
        <img src="/js/mozilla-pdf.js-d823592/web/images/document-print.svg" align="top" height="16"/>
        Print
      </button>

      <button id="download" title="Download" onclick="PDFView.download();" oncontextmenu="return false;">
        <img src="/js/mozilla-pdf.js-d823592/web/images/download.svg" align="top" height="16"/>
        Download
      </button>
      ...
      <a href="#" id="viewBookmark" title="Bookmark (or copy) current location">
        <img src="/js/mozilla-pdf.js-d823592/web/images/bookmark.svg" alt="Bookmark" align="top" height="16"/>
      </a>
      ...
      <div id="sidebarBox">
        ...
        <div id="sidebarControls">
          <button id="thumbsSwitch" title="Show Thumbnails" onclick="PDFView.switchSidebarView('thumbs')" data-selected>
            <img src="/js/mozilla-pdf.js-d823592/web/images/nav-thumbs.svg" align="top" height="16" alt="Thumbs" />
          </button>
          <button id="outlineSwitch" title="Show Document Outline" onclick="PDFView.switchSidebarView('outline')" disabled>
            <img src="/js/mozilla-pdf.js-d823592/web/images/nav-outline.svg" align="top" height="16" alt="Document Outline" />
          </button>
        </div>
      </div>
    </div>
