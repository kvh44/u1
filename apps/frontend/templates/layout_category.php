...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <?php include_metas() ?>
    <title><?php if (!include_slot('title')): ?> 优拓－建筑工程技术与项目管理的交流平台 优拓 <?php endif; ?></title>
  ...
  include_partial('global/path',array('categorys' => $sf_request->getAttribute('categorys')?$sf_request->getAttribute('categorys'):null));
  include_partial('global/left_category',array('categorys2' => $sf_request->getAttribute('categorys2')));
  ?>
