<?php
	...
	$mcImageManagerConfig['general.language'] = "zh"; // en, sv
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../uploads/myarticlephoto'; // absolute or relative from this script path, required.
