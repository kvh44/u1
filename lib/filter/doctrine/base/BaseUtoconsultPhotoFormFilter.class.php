...
/**
 * UtoconsultPhoto filter form base class.
 *
 * @package    uto
 * @subpackage filter
 ...
 */
abstract class BaseUtoconsultPhotoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'photoicon'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'photosmall'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'category_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('UtoconsultPhotoCategory'), 'column' => 'id')),
      'title'       => new sfValidatorPass(array('required' => false)),
      'content'     => new sfValidatorPass(array('required' => false)),
      'photoicon'   => new sfValidatorPass(array('required' => false)),
      'photosmall'  => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('utoconsult_photo_filters[%s]');
