...
/**
 * UtoconsultAdvertisement filter form base class.
 *
 * @package    uto
 * @subpackage filter
 ...
 */
abstract class BaseUtoconsultAdvertisementFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('utoconsult_advertisement_filters[%s]');
