...
/**
 * UtoconsultAnnoncement filter form base class.
 *
 * @package    uto
 * @subpackage filter
 ...
 */
abstract class BaseUtoconsultAnnoncementFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('utoconsult_annoncement_filters[%s]');
