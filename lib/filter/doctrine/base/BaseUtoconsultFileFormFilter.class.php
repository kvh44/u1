...
/**
 * UtoconsultFile filter form base class.
 *
 * @package    uto
 * @subpackage filter
 ...
 */
abstract class BaseUtoconsultFileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'file_original' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'file_original' => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('utoconsult_file_filters[%s]');
