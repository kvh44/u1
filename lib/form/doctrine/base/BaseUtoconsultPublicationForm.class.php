...
/**
 * UtoconsultPublication form base class.
 *
 * @method UtoconsultPublication getObject() Returns the current form's model object
 *
 * @package    uto
 * @subpackage form
 ...
 */
abstract class BaseUtoconsultPublicationForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'binaryData'  => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'binaryData'  => new sfValidatorString(),
      ...
      'mime'        => new sfValidatorString(array('max_length' => 255, 'required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'UtoconsultPublication', 'column' => array('slug')))
    );

    $this->widgetSchema->setNameFormat('utoconsult_publication[%s]');
