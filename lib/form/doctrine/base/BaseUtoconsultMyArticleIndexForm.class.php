...
/**
 * UtoconsultMyArticleIndex form base class.
 *
 * @method UtoconsultMyArticleIndex getObject() Returns the current form's model object
 *
 * @package    uto
 * @subpackage form
 ...
 */
abstract class BaseUtoconsultMyArticleIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('utoconsult_my_article_index[%s]');
